!function(){
	...
	var setup = {
		...
		stream:    'content',
		imagevariant: 'small',
		animfunc:   'fade', // fade oder slide oder float
		interval:   5000,  
		poll:       true,
		parts:      {header: 0, content: 1, footer:0.15},
		template:   '\
	...
	var jstoload = [
	  ...
	  "//d3kcx7oxb4qpd2.cloudfront.net/global/js/modules/wackenmodule.js"
	];
	if (typeof jQuery == "function") jstoload.shift(); // don't load jQuery if already present

	var csstoload = [
	  "//d3kcx7oxb4qpd2.cloudfront.net/global/js/modules/"+ setup['style'] +".css",
	  "//d3kcx7oxb4qpd2.cloudfront.net/global/css/flypicons.css",
	  "http://fonts.googleapis.com/css?family=Strait"
	];
